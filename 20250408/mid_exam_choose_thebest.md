# 📝 Midterm Exam: Python Programming (Ch. 1–11)
...
### 13. What does recursion require to avoid infinite calls?
A. A `loop`  
B. A `break` statement  
C. A base case  
D. An exception
...
### 19. What is the correct syntax to handle an exception in Python?
A. `except IOError:`  
B. `if IOError:`  
C. `raise IOError:`  
D. `try IOError:`
...
### 25. What is the result of `'hello'.upper()`?
A. `HELLO`  
B. `hello`  
C. `Hello`  
D. `hELLO`
