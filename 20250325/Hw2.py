...
def plot_cash_exchange_rate(file_path):
    try:
        ...
        plt.plot(df['資料日期'], df['本行買入現金'], label='本行買入現金', marker='o', color='blue')
        plt.plot(df['資料日期'], df['本行賣出現金'], label='本行賣出現金', marker='o', color='red')
...
if __name__ == "__main__":
    # 使用原始字串格式避免路徑問題
    excel_file_path = r"C:\Users\User\Desktop\cycu_oop_11372002\exc1.xlsx"
